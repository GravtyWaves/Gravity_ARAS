...
# ARAS Microservice – Elite Team Profile & Standards
...
3. [Member Qualifications](#member-qualifications)
4. [Collaboration & Methodology](#collaboration--methodology)
...
This document defines the elite, multidisciplinary team required to design, build, and maintain the ARAS microservice: a reusable, database-agnostic, advanced news analysis platform based on FastAPI. The team includes both technical and domain experts to ensure the highest quality, accuracy, and impact.
...
### Technical Team
- **Software Architect**: Designs system architecture, ensures scalability, security, and integration.
- **Backend Developers (Python, FastAPI)**: Build APIs, business logic, integrate NLP/analytics modules.
- **Frontend Developers (React, D3.js, Chart.js)**: Develop dashboards, user interfaces, and data visualizations.
- **DevOps Engineer**: Manage CI/CD, deployment, server infrastructure, and monitoring.
- **Database Engineer**: Design schemas, optimize queries, manage migrations (DB-agnostic infrastructure).
- **Data Scientist / NLP Engineer**: Develop models for entity extraction, sentiment, topic modeling, and trend detection.
- **Security Specialist**: Implement authentication, encryption, and conduct security audits.
- **QA Engineer / Tester**: Ensure reliability, performance, and run automated/manual tests.

### Domain Experts
- **Senior Journalist / News Analyst**: Select sources, validate content, and define news relevance.
- **Economist**: Advise on economic indicators, validate financial news and trends.
- **Political Analyst**: Provide expertise on political events, entities, and network analysis.
- **Sociologist**: Advise on social trends, sentiment, and impact analysis.
- **Cultural Expert**: Guide coverage of arts, culture, and related topics.
- **Sports Analyst**: Support sports news processing and trend identification.
- **Science & Technology Expert**: Validate tech/science news and assist in topic modeling.

### Support & Management
- **Project Manager**: Coordinate activities, timelines, and communication.
- **Product Owner**: Define product vision, requirements, and priorities.
- **UI/UX Designer**: Design user flows, wireframes, and visual assets.
- **Documentation Specialist**: Prepare technical and user documentation.
- **Legal Advisor**: Ensure compliance with privacy and copyright laws.

---

## Member Qualifications

- **PhD or Doctorate in Relevant Field**: All technical and domain experts must hold a doctoral degree in their area of expertise (e.g., Computer Science, Data Science, Economics, Political Science, Sociology, etc.).
- **High IQ and Analytical Skills**: Demonstrated exceptional intelligence, problem-solving ability, and analytical thinking.
- **Proven Expertise**: Documented experience and advanced skills directly related to their role and responsibilities in the ARAS microservice project.
- **Specialized Knowledge**: Deep understanding of the technologies, methodologies, and domain-specific requirements necessary for precise and complete project execution.
- **Collaboration and Leadership**: Ability to work in multidisciplinary teams, communicate effectively, and lead initiatives when required.

---

## Collaboration & Methodology

- Weekly all-hands meetings and daily technical standups
- Regular feedback sessions with domain experts
- Shared project management board (e.g., Jira, Trello)
- Cross-team code reviews and documentation sprints
- Continuous integration, testing, and security reviews

---

## Critical Standards

- **English-only policy** for all technical content
- **File management workflow**: Always search and update before creating new files
- **Conventional commits** and strict branch naming
- **Type hints/annotations** required for all code
...
- **Data Science**: Scikit-learn, Gensim, Hazm, spaCy, NetworkX
- **Database**: Infrastructure ready for PostgreSQL, but DB-agnostic

---

## Quick Reference

This document is the authoritative team and standards profile for the ARAS microservice. Use it to:
- Assemble and validate team composition
- Assign and clarify responsibilities
- Enforce standards and best practices
- Guide onboarding and project reviews
